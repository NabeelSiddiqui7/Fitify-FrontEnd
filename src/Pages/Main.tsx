           ...
           <DailyChecklist activities={dailyActivities} refresh={getResult}/>
            <div className="flex-col h-[52vh] py-2 px-20">
                <div className="flex h-full justify-between gap-4">
                    <div className="w-1/3 flex flex-col text-center bg-slate-900 items-center my-2 rounded-2xl drop-shadow-lg">
                        <CalorieTracker nutrition={dailyNutrition} food={dailyFood} refresh={getResult}/>
                        <div className="w-full px-20 flex justify-between py-2 my-auto">
                            <div className="w-1/3 flex items-center">
                                <h3 className="mx-1">protein</h3>
                                <div className="h-[2vh] w-[2vh] bg-red-600 rounded-full"></div>
                            </div>
                            <div className="w-1/3 flex items-center">
                                <h3 className="mx-1">carbs</h3>
                                <div className="h-[2vh] w-[2vh] bg-black rounded-full"></div>
                            </div>
                            <div className="w-1/3 flex items-center">
                    ...
                    <div className="flex grow flex-col text-center bg-slate-900 items-center my-2 rounded-2xl drop-shadow-lg">
            ...
            <div className="flex-col h-[52vh] py-2 px-20">
                <div className="flex h-full justify-between gap-4">
                    <div className="w-3/5 flex flex-col text-center bg-slate-900 items-center my-2 rounded-2xl drop-shadow-lg">
